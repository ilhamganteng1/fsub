...
BOT_TOKEN = os.environ.get("BOT_TOKEN", "8059723825:AAHZBnQZSMDlmBYPTAHAqirU0YsRAMYd8sM")
...
FORCE_SUB_CHANNEL = int(os.environ.get("FORCE_SUB_CHANNEL", "-1002452621314"))
FORCE_SUB_CHANNEL2 = int(os.environ.get("FORCE_SUB_CHANNEL2", "-1002357343731"))
...
try:
    ADMINS=[5839381774]
    for x in (os.environ.get("ADMINS", "5839381774").split()):
        ADMINS.append(int(x))
except ValueError:
